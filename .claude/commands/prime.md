...
#   Pare Grondin Services     → e.g. "The Enchanted Collective"
#   TBD — domain to be purchased after sale closes            → e.g. "enchantedmadison.com"
#   health sharing advocate and Impact Health Sharing enrollment consultant     → e.g. "luxury glamping and romantic experience property"
#   Manchester, New Hampshire          → e.g. "Madison, Indiana"
#   ASAP — launch immediately after sale closes     → e.g. "June 2026"
#   self-employed NH residents, families, and COBRA refugees paying $1,000+/month for health coverage  → e.g. "romantic couples aged 27–45 within 90 min drive"
#   Impact Health Sharing membership enrollment and 1:1 consultation        → e.g. "glamping tents, cottage, day-use hot tub escapes, proposal packages"
#   drive 1:1 consultation bookings and convert NH families and self-employed workers to Impact Health Sharing          → e.g. "drive direct bookings and own the romantic getaway category in southern Indiana"
#   Calendly (custom branded multi-step calendar component on the website)    → e.g. "Lodgify (launch) / OwnerRez (scale)"
#   LocalBusiness → ProfessionalService       → e.g. "LodgingBusiness" or "LocalBusiness" or "ProfessionalService"

---

You are the orchestrator for the **Pare Grondin Services** (TBD — domain to be purchased after sale closes) website build.
...
| Variable | Source |
|----------|--------|
| Pare Grondin Services | initial-business-data.md Section 1 |
| TBD — domain to be purchased after sale closes | initial-business-data.md Section 1 |
| health sharing advocate and Impact Health Sharing enrollment consultant | initial-business-data.md Section 1 — one-phrase description |
| Manchester, New Hampshire | initial-business-data.md Section 1 |
| ASAP — launch immediately after sale closes | initial-business-data.md Section 7 |
| self-employed NH residents, families, and COBRA refugees paying $1,000+/month for health coverage | initial-business-data.md Section 3 — specific, not generic |
| Impact Health Sharing membership enrollment and 1:1 consultation | initial-business-data.md Section 2 |
| drive 1:1 consultation bookings and convert NH families and self-employed workers to Impact Health Sharing | initial-business-data.md Section 5 |
| Calendly (custom branded multi-step calendar component on the website) | initial-business-data.md Section 5 — or "TBD — confirm before Phase 4" |
| LocalBusiness → ProfessionalService | infer from business type — LocalBusiness / ProfessionalService / LodgingBusiness |
...
**Project:** TBD — domain to be purchased after sale closes — new website build
**Client:** Pare Grondin Services | Manchester, New Hampshire
**Business Type:** health sharing advocate and Impact Health Sharing enrollment consultant
**Launch Target:** ASAP — launch immediately after sale closes
**Last Updated:** [DATE]
...
19. Route structure — /service-areas/[city]:
    ...
    A. src/app/service-areas/page.tsx — index page
       ...
       - generateMetadata: title "Service Areas | Pare Grondin Services"
    ...
    C. src/app/service-areas/[city]/page.tsx — individual city page (SERVER component)
       ...
       - generateMetadata({ params }): unique title + description per city
         title: "[Service] in [City], [State] | Pare Grondin Services"
