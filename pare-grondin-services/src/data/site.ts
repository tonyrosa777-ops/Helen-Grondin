...
export const pricingTiers = [
  ...
  },
  {
    ...
    deposit: 2750,
    badge: null,
    description: "Full marketing machine — more traffic, deeper conversion, passive list building",
    features: [
      "Everything in Pro",
      "Enhanced savings calculator (personalized PDF report emailed to prospect)",
      "10 programmatic service area pages (NH cities, local SEO)",
      "Lead magnet PDF + email gate (passive list builder)",
