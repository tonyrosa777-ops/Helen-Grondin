...
export const siteConfig = {
  ...
  wordmark: "Pare Grondin Services", // Visual brand mark used in nav and footer
  tagline: "Where Healthcare Finally Makes Sense",
  description:
    "Pare Grondin Services helps New Hampshire families, self-employed workers, and COBRA refugees cut their healthcare costs by 40-60% through Impact Health Sharing — a nonprofit alternative to insurance.",
...
export const pricingTiers = [
  {
    ...
    deposit: 750,
    badge: null,
    description: "Gets you online professionally and makes a strong first impression. Doesn't have the tools to convert visitors into booked calls.",
    features: [
      "Animated hero section (3-layer particle + SVG)",
      "Homepage with all core sections",
      "About, Services, Contact, FAQ pages",
      "32 client testimonials page",
      "Mobile-first responsive design",
      "SEO foundation (schema, meta, sitemap)",
      "Vercel deployment + 30-day revision window",
    ],
  },
  {
    name: "Pro",
    ...
    deposit: 1500,
    badge: "Most Popular",
    description: "Everything in Starter, plus the tools that turn strangers into booked consultations. This is the package that pays for itself.",
    features: [
  ...
  },
  {
    ...
    deposit: 2750,
    badge: null,
    description: "Everything in Pro, plus the infrastructure to own NH health sharing searches for years — not just today.",
    features: [
      "Everything in Pro",
      "10 programmatic NH city pages — own 'health sharing [city] NH' in Manchester, Nashua, Concord + 7 more cities",
      "Lead magnet + email gate — free guide captures leads who aren't ready to book yet",
