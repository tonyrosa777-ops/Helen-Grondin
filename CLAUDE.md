# CLAUDE.md — Pare Grondin Services Project Rules
#
# VARIABLES TO FILL (Task 1 of /prime will complete these):
#   Pare Grondin Services     → e.g. "The Enchanted Collective"
#   TBD — domain purchased after sale closes            → e.g. "enchantedmadison.com"
...
#   ASAP — immediately after sale closes     → e.g. "June 2026"
...
#   Calendly (custom branded multi-step calendar component)    → e.g. "Lodgify (launch) / OwnerRez (scale)"
...
get filled variables (Pare Grondin Services, TBD — domain purchased after sale closes, etc. — already substituted by /prime).
...
Never embed third-party redirects that take users off the TBD — domain purchased after sale closes domain.
...
Calendly (custom branded multi-step calendar component). Every extra click costs conversions. Every domain redirect
costs trust.

## SEO Rule
Every page must include: semantic HTML5 structure, unique title tag, meta
description, Open Graph tags, LocalBusiness → ProfessionalService schema markup, crawlable text
